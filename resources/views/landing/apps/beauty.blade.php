	...
	<div class="feature">
	    <div class="beauty">
	                ...
	                <div class="padding-left-right">
	                    <div class="row">
	                        <div class="col-md-7 col-xs-12">
	                            <div class="cnt">
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/beauty.png') }}" class="logo">
	                                ...
	                                <ul class="list-inline">
	                                    <li>
	                                        <img src="{{ asset('landing/resources/image/feature_app/beauty/icons/001.png') }}">
	                                        <div class="text-center">Eyes</div>
	                                    </li>
	                                    <li>
	                                        <img src="{{ asset('landing/resources/image/feature_app/beauty/icons/002.png') }}">
	                                        <div class="text-center">Face</div>
	                                    </li>
	                                    <li>
	                                        <img src="{{ asset('landing/resources/image/feature_app/beauty/icons/003.png') }}">
	                                        <div class="text-center">Hair</div>
	                                    </li>
	                                    <li>
	                                        <img src="{{ asset('landing/resources/image/feature_app/beauty/icons/004.png') }}">
	                                        <div class="text-center">Skin</div>
	                                    </li>
	                                    <li>
	                                        <img src="{{ asset('landing/resources/image/feature_app/beauty/icons/005.png') }}">
	                                ...
	                                <a class="fr_a_font_light apk_download" id="apk_download" href="{{ asset('landing/vendors/apk/beauty.apk') }}" download="beauty.apk">
	                                  Download
	                                </a>
	                            </div>
	                        </div>
	                        <div class="col-md-5 hidden-xs">
	                            <img src="{{ asset('landing/resources/image/feature_app/beauty/mockup.png') }}">
	                        </div>
	                    </div>
	                </div>
	            </div>
	        ...
	        <div class="mobile_mockup">
	            <div class="container-fluid">
	                <div class="padding-left-right">
	                    <img src="{{ asset('landing/resources/image/feature_app/beauty/mobile_mockup.png') }}" class="img-responsive">
	                </div>
	            </div>
	        </div>
	                    ...
	                    <ul class="nav nav-tabs nav-pills nav-fill">
	                        <li class="active">
	                            <a data-toggle="tab" href="#tab1">
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/small/01.png') }}">
	                                <br>
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/icons/01.png') }}" class="icon">
	                                <p>Eyes</p>
	                            </a>
	                        </li>
	                        <li>
	                            <a data-toggle="tab" href="#tab2">
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/small/02.png') }}">
	                                <br>
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/icons/02.png') }}" class="icon">
	                                <p>Face</p>
	                            </a>
	                        </li>
	                        <li>
	                            <a data-toggle="tab" href="#tab3">
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/small/03.png') }}">
	                                <br>
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/icons/03.png') }}" class="icon">
	                                <p>Hair</p>
	                            </a>
	                        </li>
	                        <li>
	                            <a data-toggle="tab" href="#tab4">
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/small/04.png') }}">
	                                <br>
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/icons/04.png') }}" class="icon">
	                                <p>Skin</p>
	                            </a>
	                        </li>
	                        <li>
	                            <a data-toggle="tab" href="#tab5">
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/small/05.png') }}">
	                                <br>
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/icons/05.png') }}" class="icon">
	                                <p>Arms & Feet</p>
	                            </a>
	                        </li>
	                    </ul>
	                    ...
	                    <div class="tab-content">
	                        <div id="tab1" class="tab-pane fade in active">
	                          <div class="row">
	                              ...
	                              <div class="col-md-5">
	                                  <img src="{{ asset('landing/resources/image/feature_app/beauty/big/01.png') }}">
	                              </div>
	                          </div>
	                        </div>
	                        <div id="tab2" class="tab-pane fade">
	                          <div class="row">
	                            ...
	                            <div class="col-md-5">
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/big/02.png') }}">
	                            </div>
	                          </div>
	                        </div>
	                        <div id="tab3" class="tab-pane fade">
	                          <div class="row">
	                            ...
	                            <div class="col-md-5">
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/big/03.png') }}">
	                            </div>
	                          </div>
	                        </div>
	                        <div id="tab4" class="tab-pane fade">
	                          <div class="row">
	                            ...
	                            <div class="col-md-5">
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/big/04.png') }}">
	                            </div>
	                          </div>
	                        </div>
	                        <div id="tab5" class="tab-pane fade">
	                          <div class="row">
	                            ...
	                            <div class="col-md-5">
	                                <img src="{{ asset('landing/resources/image/feature_app/beauty/big/05.png') }}">
	                            </div>
	                          </div>
	                        </div>
	                    </div>
