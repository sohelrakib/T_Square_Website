...
<div class="feature">
    <div class="islamic">
                ...
                <div class="padding-left-right">
                    <div class="row">
                        <div class="col-md-7 col-xs-12">
                            <div class="cnt">
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/logo.png') }}" class="logo">
                                ...
                                <ul class="list-inline">
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/islamic/icons/001.png') }}">
                                        <div class="text-center bangla_font">নামাজের সময়সূচী</div>
                                        
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/islamic/icons/002.png') }}">
                                        <div class="text-center bangla_font">আল কুরআন</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/islamic/icons/003.png') }}">
                                        <div class="text-center bangla_font">হাদিস</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/islamic/icons/004.png') }}">
                                        <div class="text-center bangla_font">গুরুত্বপূর্ণ দুয়া</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/islamic/icons/005.png') }}">
                                ...
                                <!-- <a class="fr_a_font_light apk_download" href="">
                                  Download
                                </a> -->
                            </div>
                        </div>
                        <div class="col-md-5 hidden-xs">
                            <img src="{{ asset('home_page/resources/image/feature_app/islamic/mockup.png') }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mobile_mockup">
            <div class="container-fluid">
                <div class="padding-left-right">
                    <img src="{{ asset('home_page/resources/image/feature_app/islamic/mobile_mockup.png') }}" class="img-responsive" data-aos="zoom-in">
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs nav-pills nav-fill">
                        <li class="active">
                            <a data-toggle="tab" href="#tab1">
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/small/namaj.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/icons/01.png') }}" class="icon">
                                <p class="bangla_font">নামাজের সময়সূচী</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab2">
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/small/al_quran.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/icons/02.png') }}" class="icon">
                                <p class="bangla_font">আল কুরআন</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab3">
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/small/hadis.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/icons/03.png') }}" class="icon">
                                <p class="bangla_font">হাদিস</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab4">
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/small/importent_dua.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/icons/04.png') }}" class="icon">
                                <p class="bangla_font">গুরুত্বপূর্ণ দুয়া</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab5">
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/small/kibla_compass.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/icons/05.png') }}" class="icon">
                    ...
                    <div class="tab-content">
                        <div id="tab1" class="tab-pane fade in active">
                          <div class="row">
                              ...
                              <div class="col-md-5">
                                  <img src="{{ asset('home_page/resources/image/feature_app/islamic/big/01.png') }}">
                              </div>
                          </div>
                        </div>
                        <div id="tab2" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/big/02.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab3" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/big/03.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab4" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/big/04.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab5" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/islamic/big/05.png') }}">
                            </div>
                          </div>
                        </div>
                    </div>
              ...
              <div class="tot-cnt">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <p>Subscribe to Islamic Service</p>
                  </div>
  
                  <div class="col-md-6">
                    <p>
                      Sign up to Islamic App for notification and all offer also Valid
