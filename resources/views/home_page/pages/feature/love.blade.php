...
<div class="feature">
    <div class="love">
                ...
                <div class="padding-left-right">
                    <div class="row">
                        <div class="col-md-7 col-xs-12">
                            <div class="cnt">
                                <img src="{{ asset('home_page/resources/image/feature_app/love/love.png') }}" class="logo">
                                ...
                                <ul class="list-inline">
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/love/icons/001.png') }}">
                                        <div class="text-center">Love Calculator</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/love/icons/002.png') }}">
                                        <div class="text-center">Special Day Reminder</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/love/icons/003.png') }}">
                                        <div class="text-center">Love Tips</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/love/icons/004.png') }}">
                                        <div class="text-center">Love Wallpaper</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/love/icons/005.png') }}">
                        ...
                        <div class="col-md-5 hidden-xs">
                            <img src="{{ asset('home_page/resources/image/feature_app/love/mockup.png') }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mobile_mockup">
            <div class="container-fluid">
                <div class="padding-left-right">
                    <img src="{{ asset('home_page/resources/image/feature_app/love/mobile_mockup.png') }}" class="img-responsive" data-aos="zoom-in">
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs nav-pills nav-fill">
                        <li class="active">
                            <a data-toggle="tab" href="#tab1">
                                <img src="{{ asset('home_page/resources/image/feature_app/love/small/01.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/love/icons/01.png') }}" class="icon">
                                <p>Love Calculator</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab2">
                                <img src="{{ asset('home_page/resources/image/feature_app/love/small/02.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/love/icons/02.png') }}" class="icon">
                                <p>Special Day Reminder</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab3">
                                <img src="{{ asset('home_page/resources/image/feature_app/love/small/03.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/love/icons/03.png') }}" class="icon">
                                <p>Love Tips</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab4">
                                <img src="{{ asset('home_page/resources/image/feature_app/love/small/04.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/love/icons/04.png') }}" class="icon">
                                <p>Love Wallpaper</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab5">
                                <img src="{{ asset('home_page/resources/image/feature_app/love/small/05.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/love/icons/05.png') }}" class="icon">
                                <p>Love Diary</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div id="tab1" class="tab-pane fade in active">
                          <div class="row">
                              ...
                              <div class="col-md-5">
                                  <img src="{{ asset('home_page/resources/image/feature_app/love/big/01.png') }}">
                              </div>
                          </div>
                        </div>
                        <div id="tab2" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/love/big/02.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab3" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/love/big/03.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab4" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/love/big/04.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab5" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/love/big/05.png') }}">
                            </div>
                          </div>
                        </div>
                    </div>
              ...
              <div class="tot-cnt">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <p>Subscribe to love App for Your Loves Services</p>
                  </div>
  
                  <div class="col-md-6">
                    <p>
                      Sign up to Love App for notification and all offer also Valid
