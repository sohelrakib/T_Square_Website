...
<div class="feature">
    <div class="joke">
                ...
                <div class="padding-left-right">
                    <div class="row">
                        <div class="col-md-7 col-xs-12">
                            <div class="cnt">
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/joke.png') }}" class="logo">
                                ...
                                <ul class="list-inline">
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/joke/icons/001.png') }}">
                                        <div class="text-center">স্বামী স্ত্রী জোকস</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/joke/icons/002.png') }}">
                                        <div class="text-center">ছাত্র শিক্ষক জোকস</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/joke/icons/003.png') }}">
                                        <div class="text-center">অফিস জোকস</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/joke/icons/004.png') }}">
                                        <div class="text-center">বাঙ্গালী স্ট্যাটাস জোকস</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/joke/icons/005.png') }}">
                        ...
                        <div class="col-md-5 hidden-xs">
                            <img src="{{ asset('home_page/resources/image/feature_app/joke/mockup.png') }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mobile_mockup">
            <div class="container-fluid">
                <div class="padding-left-right">
                    <img src="{{ asset('home_page/resources/image/feature_app/joke/mobile_mockup.png') }}" class="img-responsive" data-aos="zoom-in">
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs nav-pills nav-fill">
                        <li class="active">
                            <a data-toggle="tab" href="#tab1">
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/small/01.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/icons/01.png') }}" class="icon">
                                <p>স্বামী স্ত্রী জোকস</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab2">
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/small/02.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/icons/02.png') }}" class="icon">
                                <p>ছাত্র শিক্ষক জোকস</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab3">
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/small/03.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/icons/03.png') }}" class="icon">
                                <p>অফিস জোকস</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab4">
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/small/04.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/icons/04.png') }}" class="icon">
                                <p>বাঙ্গালী স্ট্যাটাস জোকস</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab5">
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/small/05.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/icons/05.png') }}" class="icon">
                    ...
                    <div class="tab-content">
                        <div id="tab1" class="tab-pane fade in active">
                          <div class="row">
                              ...
                              <div class="col-md-5">
                                  <img src="{{ asset('home_page/resources/image/feature_app/joke/big/01.png') }}">
                              </div>
                          </div>
                        </div>
                        <div id="tab2" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/big/02.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab3" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/big/03.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab4" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/big/04.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab5" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/joke/big/05.png') }}">
                            </div>
                          </div>
                        </div>
                    </div>
              ...
              <div class="tot-cnt">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <p>Subscribe to Joke App for Your Jokes Services</p>
                  </div>
  
                  <div class="col-md-6">
                    <p>
                      Sign up to Joke App for notification and all offer also Valid
