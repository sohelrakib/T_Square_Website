...
<div class="feature">
    <div class="health">
                ...
                <div class="padding-left-right">
                    <div class="row">
                        <div class="col-md-7 col-xs-12">
                            <div class="cnt">
                                <img src="{{ asset('home_page/resources/image/feature_app/health/health.png') }}" class="logo">
                                ...
                                <ul class="list-inline">
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/health/icons/001.png') }}">
                                        <div class="text-center">General Health Tips</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/health/icons/002.png') }}">
                                        <div class="text-center">Important Number</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/health/icons/003.png') }}">
                                        <div class="text-center">Step Count</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/health/icons/004.png') }}">
                                        <div class="text-center">Medicine Reminder</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/health/icons/005.png') }}">
                        ...
                        <div class="col-md-5 hidden-xs">
                            <img src="{{ asset('home_page/resources/image/feature_app/health/mockup.png') }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mobile_mockup">
            <div class="container-fluid">
                <div class="padding-left-right">
                    <img src="{{ asset('home_page/resources/image/feature_app/health/mobile_mockup.png') }}" class="img-responsive" data-aos="zoom-in">
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs nav-pills nav-fill">
                        <li class="active">
                            <a data-toggle="tab" href="#tab1">
                                <img src="{{ asset('home_page/resources/image/feature_app/health/small/01.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/health/icons/01.png') }}" class="icon">
                                <p>General Health Tips</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab2">
                                <img src="{{ asset('home_page/resources/image/feature_app/health/small/02.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/health/icons/02.png') }}" class="icon">
                                <p>Important Number</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab3">
                                <img src="{{ asset('home_page/resources/image/feature_app/health/small/03.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/health/icons/03.png') }}" class="icon">
                                <p>Step Count</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab4">
                                <img src="{{ asset('home_page/resources/image/feature_app/health/small/04.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/health/icons/04.png') }}" class="icon">
                                <p>Medicine Reminder</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab5">
                                <img src="{{ asset('home_page/resources/image/feature_app/health/small/05.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/health/icons/05.png') }}" class="icon">
                                <p>Healthy Foods</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div id="tab1" class="tab-pane fade in active">
                          <div class="row">
                              ...
                              <div class="col-md-5">
                                  <img src="{{ asset('home_page/resources/image/feature_app/health/big/01.png') }}">
                              </div>
                          </div>
                        </div>
                        <div id="tab2" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/health/big/02.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab3" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/health/big/03.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab4" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/health/big/04.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab5" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/health/big/05.png') }}">
                            </div>
                          </div>
                        </div>
                    </div>
              ...
              <div class="tot-cnt">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <p>Subscribe to Health App for Your Health Services</p>
                  </div>
  
                  <div class="col-md-6">
                    <p>
                      Sign up to Health App for notification and all offer also Valid
