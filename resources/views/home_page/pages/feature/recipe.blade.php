...
<div class="feature">
    <div class="recipe">
                ...
                <div class="padding-left-right">
                    <div class="row">
                        <div class="col-md-7 col-xs-12">
                            <div class="cnt">
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/recipe.png') }}" class="logo">
                                ...
                                <ul class="list-inline">
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/recipe/icons/001.png') }}">
                                        <div class="text-center bangla_font">বাংলা রেসিপি</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/recipe/icons/002.png') }}">
                                        <div class="text-center bangla_font">ইন্ডিয়ান রেসিপি</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/recipe/icons/003.png') }}">
                                        <div class="text-center bangla_font">চাইনিজ রেসিপি</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/recipe/icons/004.png') }}">
                                        <div class="text-center bangla_font">ডেজার্ট রেসিপি</div>
                                    </li>
                                    <li>
                                        <img src="{{ asset('home_page/resources/image/feature_app/recipe/icons/005.png') }}">
                        ...
                        <div class="col-md-5 hidden-xs">
                            <img src="{{ asset('home_page/resources/image/feature_app/recipe/mockup.png') }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mobile_mockup">
            <div class="container-fluid">
                <div class="padding-left-right">
                    <img src="{{ asset('home_page/resources/image/feature_app/recipe/mobile_mockup.png') }}" class="img-responsive" data-aos="zoom-in">
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs nav-pills nav-fill">
                        <li class="active">
                            <a data-toggle="tab" href="#tab1">
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/small/01.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/icons/01.png') }}" class="icon">
                                <p class="bangla_font">বাংলা রেসিপি</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab2">
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/small/02.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/icons/02.png') }}" class="icon">
                                <p class="bangla_font">ইন্ডিয়ান রেসিপি</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab3">
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/small/03.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/icons/03.png') }}" class="icon">
                                <p class="bangla_font">চাইনিজ রেসিপি</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab4">
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/small/04.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/icons/04.png') }}" class="icon">
                                <p class="bangla_font">ডেজার্ট রেসিপি</p>
                            </a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#tab5">
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/small/05.png') }}">
                                <br>
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/icons/05.png') }}" class="icon">
                    ...
                    <div class="tab-content">
                        <div id="tab1" class="tab-pane fade in active">
                          <div class="row">
                              ...
                              <div class="col-md-5">
                                  <img src="{{ asset('home_page/resources/image/feature_app/recipe/big/01.png') }}">
                              </div>
                          </div>
                        </div>
                        <div id="tab2" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/big/02.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab3" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/big/03.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab4" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/big/04.png') }}">
                            </div>
                          </div>
                        </div>
                        <div id="tab5" class="tab-pane fade">
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <img src="{{ asset('home_page/resources/image/feature_app/recipe/big/05.png') }}">
                            </div>
                          </div>
                        </div>
                    </div>
              ...
              <div class="tot-cnt">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <p>Subscribe to Recipe App for Your Recipes Services</p>
                  </div>
  
                  <div class="col-md-6">
                    <p>
                      Sign up to Recipe App for notification and all offer also Valid
